...
notion_todos = fetch_all_notion_todos()
page_id_to_notion_page = {page["id"]: page for page in notion_todos}
...
if r.status_code == 200:
    ...
    for ev in ai_events:
        ...
        if conflict:
            ...
            try:
                page_data = page_id_to_notion_page.get(pid)
                if page_data:
                    ...
                    if notion_start != start_str:
                        ...
                        requests.patch(f"https://api.notion.com/v1/pages/{pid}", headers=notion_h, json=payload, timeout=10)
